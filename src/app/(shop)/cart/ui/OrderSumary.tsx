  ...
  return (
    <div className="bg-white rounded-xl shadow-xl p-7 h-fit ">
      ...
      <div className="grid grid-cols-2">
        ...
        <span>Subtotal</span>
        <span className="text-right">$ {orderSumary.subtotal} </span>

        <span>Impuestos (15%)</span>
        <span className="text-right">$ {orderSumary.tax} </span>

        <span className="text-2xl mt-5">Total</span>
        <span className="text-2xl mt-5 text-right">$ {orderSumary.total} </span>
      </div>
